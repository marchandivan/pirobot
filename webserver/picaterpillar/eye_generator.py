...
class EyeGenerator(object):
    moods = {
        "surprised": dict(left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.7,
                                        eye_brows_angle=0, eye_brows_height=0.4),
                          right_eye=dict(radius=60, x=240, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.7,
                                         eye_brows_angle=0,
                                         eye_brows_height=0.4)),
        "relaxed": dict(left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.5,
                                      eye_brows_angle=0,
        ...
        "crazy": dict(left_eye=dict(radius=50, x=80, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.4,
                      ...
                      right_eye=dict(radius=60, x=240, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.6,
                                     eye_brows_angle=20,
                                     eye_brows_height=0.2)),
        "sad": dict(left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.4,
                                 eye_brows_angle=-20,
        ...
        "mad": dict(left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.6,
                    ...
                    right_eye=dict(radius=60, x=240, y=130, pupil_angle=90, pupil_pos=0.0, pupil_size=0.6,
                                   eye_brows_angle=-30,
                                   eye_brows_height=0.3)),
        "shamed": dict(left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.8, pupil_size=0.1,
                                     eye_brows_angle=-20,
        ...
        "skeptical": dict(
            ...
            right_eye=dict(radius=60, x=240, y=130, pupil_angle=-90, pupil_pos=0.8,
                           ...
                           eye_brows_height=0.0)),
        "smile": dict(
            left_eye=dict(radius=60, x=80, y=130, pupil_angle=90, pupil_pos=0.2, pupil_size=0.6,
                          eye_brows_angle=0,
                          eye_brows_height=0.5),
            right_eye=dict(radius=60, x=240, y=130, pupil_angle=90, pupil_pos=0.2, pupil_size=0.6,
                           eye_brows_angle=0,
                           eye_brows_height=0.5)),
        "silly": dict(
            left_eye=dict(radius=60, x=80, y=130, pupil_angle=0, pupil_pos=1.0, pupil_size=0.5,
                          eye_brows_angle=5,
                          eye_brows_height=0.1),
            right_eye=dict(radius=60, x=240, y=130, pupil_angle=180, pupil_pos=1.0,
                           pupil_size=0.5, eye_brows_angle=-5,
                           eye_brows_height=0.1))
    }
